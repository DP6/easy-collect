function ga4Event(event_name, params, ecommerce, id) {
  try {
    ...
    if (/*options.dataLayerEcommerce === 'ga3'*/ false) {
    ...
    var result = {
      event: /*options.customNameGA4Event*/ 'ga4_event',
    ...
    /*log*/ console.log('info', data);
    window[/*options.dataLayerName*/'dataLayer'].push(merge(result, data));
  } catch (err) {
    /*log*/ console.log('warn', err);
  }
}
